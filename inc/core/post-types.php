...
class HAM_Post_Types {
    ...
    {
        $labels = array(
            'name'                  => __('Evaluations', 'headless-access-manager'),
            'singular_name'         => __('Evaluation', 'Post type singular name', 'headless-access-manager'),
            'menu_name'             => __('Evaluations', 'headless-access-manager'),
            'name_admin_bar'        => __('Evaluation', 'Add New on Toolbar', 'headless-access-manager'),
            'add_new'               => __('Add New', 'headless-access-manager'),
            'add_new_item'          => __('Add New Evaluation', 'headless-access-manager'),
            'new_item'              => __('New Evaluation', 'headless-access-manager'),
            'edit_item'             => __('Edit Evaluation', 'headless-access-manager'),
            'view_item'             => __('View Evaluation', 'headless-access-manager'),
            'all_items'             => __('All Evaluations', 'headless-access-manager'),
            'search_items'          => __('Search Evaluations', 'headless-access-manager'),
            'not_found'             => __('No evaluations found.', 'headless-access-manager'),
            'not_found_in_trash'    => __('No evaluations found in Trash.', 'headless-access-manager'),
            'filter_items_list'     => __('Filter evaluations list', 'headless-access-manager'),
            'items_list_navigation' => __('Evaluations list navigation', 'headless-access-manager'),
            'items_list'            => __('Evaluations list', 'headless-access-manager'),
        );
